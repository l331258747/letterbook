package com.csxs.core.imageloader;
...
import com.csxs.core.imageloader.listener.IGetBitmapListener;
import com.csxs.core.imageloader.listener.IGetDrawableListener;
import com.csxs.core.imageloader.listener.IImageLoaderListener;
import com.csxs.core.imageloader.listener.ImageSize;
import com.csxs.core.imageloader.okhttp.OnGlideImageViewListener;
import com.csxs.core.imageloader.okhttp.OnProgressListener;
import com.csxs.core.imageloader.okhttp.ProgressManager;
import com.csxs.core.imageloader.tranform.BlurBitmapTranformation;
import com.csxs.core.imageloader.tranform.GlideCircleTransformation;
...
public class GlideImageLoaderClient implements IImageLoaderClient {
    ...
    public RequestOptions roundRequestOptions(int placeholderResId, int errorResId, int radius) {
        return requestOptions(placeholderResId, errorResId)
                .transform(new CenterCrop(),new RoundBitmapTranformation(radius));
    }
    /**
     *
     * @param context
