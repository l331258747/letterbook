package com.csxs.viewlib.titlebar;
...
//            }
     ...
     * @param textColor
     */
    public void setRightText(String text, int textSize, int textColor){
        rightType=TYPE_RIGHT_TEXTVIEW;
        rightText =text;
        rightTextColor = textColor;
        rightTextSize = ScreenUtils.dp2PxInt(getContext(), textSize);
        initMainRightViews(getContext());
    }
