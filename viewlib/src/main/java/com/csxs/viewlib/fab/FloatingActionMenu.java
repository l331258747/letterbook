...
//        mImageToggle.setScaleType(ImageView.ScaleType.FIT_XY);
        mImageToggle.setImageDrawable(mIcon);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(DensityUtil.dip2px(getContext(),46),
                DensityUtil.dip2px(getContext(),40));//两个400分别为添加图片的大小
        mImageToggle.setLayoutParams(params);
