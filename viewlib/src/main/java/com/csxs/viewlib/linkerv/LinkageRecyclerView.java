package com.csxs.viewlib.linkerv;
/*
...
import com.csxs.viewlib.linkerv.adapter.LinkagePrimaryAdapter;
import com.csxs.viewlib.linkerv.adapter.LinkageSecondaryAdapter;
...
import com.csxs.viewlib.linkerv.defaults.DefaultLinkagePrimaryAdapterConfig;
import com.csxs.viewlib.linkerv.defaults.DefaultLinkageSecondaryAdapterConfig;
import com.csxs.viewlib.linkerv.manager.RecyclerViewScrollHelper;
        ...
        mPrimaryAdapter = new LinkagePrimaryAdapter(mInitGroupNames, primaryAdapterConfig,
                new LinkagePrimaryAdapter.OnLinkageListener() {
                    ...
                    public void onLinkageClick(LinkagePrimaryViewHolder holder, String title) {
                        ...
                        holder.mGroupFlag.setBackgroundColor(getResources().getColor(R.color.trans));
                        holder.mLayout.setBackgroundColor(getResources().getColor(R.color.white_f4f5f7));
                ...
                if (groupNameChanged) {
                    ...
                    for (int i = 0; i < groupNames.size(); i++) {
                        if (groupNames.get(i).equals(mLastGroupName)) {
                            Log.e("groupNames.get(i):",groupNames.get(i)+"---mLastGroupName---:"+mLastGroupName);
