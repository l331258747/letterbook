...
*/
package com.csxs.viewlib.statelayout;
...
public class StateLayoutManager {
    ...
    private StateLayoutManager(Builder builder , boolean wrapContent) {
        ...
        this.errorOnClickId=builder.errorOnClickId;
...
//        rootFrameLayout.setBackgroundColor(Color.WHITE);
        rootFrameLayout.setBackground(null);
        //设置状态管理器
    ...
    public static final class Builder {
        ...
        public Builder errorOnClickId(int errorOnClickId) {
            this.errorOnClickId = errorOnClickId;
            return this;
        }
