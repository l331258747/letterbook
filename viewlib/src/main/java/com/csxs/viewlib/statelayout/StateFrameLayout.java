        ...
        switch (id) {
            ...
            case LAYOUT_ERROR_ID:
                if (mStatusLayoutManager.errorVs != null) {
                    ...
                    if(mStatusLayoutManager.errorOnClickId!=0){
                        view.findViewById(mStatusLayoutManager.errorOnClickId).setOnClickListener(new OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                if( mStatusLayoutManager.onRetryListener!=null){
