...
import com.csxs.viewlib.cartlayout.listener.OnCheckChangeListener;
...
public abstract class CartAdapter<VH extends CartViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case ICartItem.TYPE_TOTAL:
                View totalView = layoutInflater.inflate(getShopItemTotalLayout(), parent, false);
                viewHolder = getShopItemTotalLayout(totalView);
                break;
            case ICartItem.TYPE_BOTTOM_EMPTY:
                View bottomEmpty = layoutInflater.inflate(getBottomEmptyLayout(), parent, false);
                viewHolder = getEmptyViewHolder(bottomEmpty);
                break;
            default:
    ...
    protected abstract VH getShopItemTotalLayout(View itemView);

    protected abstract VH getEmptyViewHolder(View itemView);
     ...
     * @return
     */
    protected abstract @LayoutRes int getChildItemLayout();

    protected abstract @LayoutRes int getGroupItemLayout();

    protected abstract @LayoutRes int getNormalItemLayout();

    protected abstract @LayoutRes int getShopItemTotalLayout();

    protected abstract @LayoutRes int getBottomEmptyLayout();
