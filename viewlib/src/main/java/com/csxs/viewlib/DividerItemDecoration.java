...
//        mPaint.setColor(UIUtils.getColor(R.color.lightgray));
    ...
    public DividerItemDecoration(Context context, int orientation, int size, int color) {
        this.mOrientation = orientation;
        this.mItemSize = size;
        if (orientation != LinearLayoutManager.VERTICAL && orientation != LinearLayoutManager.HORIZONTAL) {
            throw new IllegalArgumentException("请传入正确的参数");
    ...
    public DividerItemDecoration(Context context, int orientation, int size, int color, boolean lastData) {
        this.mOrientation = orientation;
        this.mItemSize = size;
    ...
    public DividerItemDecoration(Context context, int orientation, int size, int color, int leftMargin, int rightMargin) {
        this.mOrientation = orientation;
        this.mItemSize = size;
    ...
    public DividerItemDecoration setLeftMargin(int margin) {
        this.leftMargin = margin;
        return this;
    }


    public DividerItemDecoration setRightMargin(int margin) {
