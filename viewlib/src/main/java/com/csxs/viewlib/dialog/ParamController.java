 ...
 **/
public class ParamController<A extends BaseDialogAdapter> implements Parcelable, Serializable {
    ...
    protected ParamController(Parcel in) {
    ...
    public static final Creator<ParamController> CREATOR = new Creator<ParamController>() {
        @Override
        public ParamController createFromParcel(Parcel in) {
            return new ParamController(in);
        }

        @Override
        public ParamController[] newArray(int size) {
            return new ParamController[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeBoolean(isNavigationBarExist);
    ...
    public void setNavigationBarExist(boolean navigationBarExist) {
        isNavigationBarExist = navigationBarExist;
    }
    ...
    public void setAdapterItemClickListener(BaseDialogAdapter.OnAdapterItemClickListener adapterItemClickListener) {
    ...
    public static class DialogParams<A extends BaseDialogAdapter> {
        ...
        public void apply(ParamController tController) {
            ...
            tController.isNavigationBarExist=isNavigationBarExist;
