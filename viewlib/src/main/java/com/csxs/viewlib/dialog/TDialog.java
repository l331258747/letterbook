package com.csxs.viewlib.dialog;
...
import com.csxs.viewlib.dialog.listener.OnBindViewListener;
...
public class TDialog extends BaseDialogFragment {
    ...
    protected ParamController paramController;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            paramController = (ParamController) savedInstanceState.getSerializable(KEY_TCONTROLLER);
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putParcelable(KEY_TCONTROLLER, paramController);
    ...
    public void onDismiss(DialogInterface dialog) {
        ...
        DialogInterface.OnDismissListener onDismissListener = paramController.getOnDismissListener();
    ...
    protected int getLayoutRes() {
        return paramController.getLayoutRes();
    }

    @Override
    protected View getDialogView() {
        return paramController.getDialogView();
    }
    ...
    protected void bindView(View view) {
        ...
        if (paramController.getIds() != null && paramController.getIds().length > 0) {
            for (int id : paramController.getIds()) {
                viewHolder.addOnClickListener(id);
            }
        }
        //回调方法获取到布局,进行处理
        if (paramController.getOnBindViewListener() != null) {
            paramController.getOnBindViewListener().bindView(viewHolder);
        }
    }

    @Override
    public int getGravity() {
        return paramController.getGravity();
    }

    @Override
    public float getDimAmount() {
        return paramController.getDimAmount();
    }

    @Override
    public int getDialogHeight() {
        return paramController.getHeight();
    }

    @Override
    public int getDialogWidth() {
        return paramController.getWidth();
    }

    @Override
    public String getFragmentTag() {
        return paramController.getTag();
    }

    public OnViewClickListener getOnViewClickListener() {
        return paramController.getOnViewClickListener();
    }

    @Override
    protected boolean isCancelableOutside() {
        return paramController.isCancelableOutside();
    }

    @Override
    protected int getDialogAnimationRes() {
        return paramController.getDialogAnimationRes();
    }

    @Override
    protected DialogInterface.OnKeyListener getOnKeyListener() {
        return paramController.getOnKeyListener();
    }

    public TDialog show() {
        Log.d(TAG, "show");
        try {
            FragmentTransaction ft = paramController.getFragmentManager().beginTransaction();
            ft.add(this, paramController.getTag());
    ...
    public static class Builder {
        ...
        ParamController.DialogParams params;

        public Builder(FragmentManager fragmentManager) {
            params = new ParamController.DialogParams();
        ...
        public TDialog create() {
            ...
            params.apply(dialog.paramController);
            return dialog;
        }
    }
}
