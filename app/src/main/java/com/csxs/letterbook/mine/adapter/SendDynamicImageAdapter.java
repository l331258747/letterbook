...
public class SendDynamicImageAdapter extends RecyclerView.Adapter<SendDynamicImageAdapter.ViewHolder> {
    ...
    public SendDynamicImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_send_dynamic_image,
                viewGroup, false);
            ...
            viewHolder.mIvDel.setOnClickListener(view -> {
                ...
                if (index != RecyclerView.NO_POSITION && list.size() > index) {
                    ...
                    if (deleteItemClickListener!=null){
                        deleteItemClickListener.onItemLongClick(this,position,view);
                    }
                }
            });
...
//            viewHolder.tvDuration.setText(DateUtils.formatDurationTime(duration));
    ...
    public OnDeleteItemClickListener getDeleteItemClickListener() {
        return deleteItemClickListener;
    }
