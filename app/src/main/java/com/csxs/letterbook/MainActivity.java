 ...
 */
public class MainActivity extends BaseDiffActivity<HomePresenter>{
    ...
    protected void onInitData() {
        Toast.makeText(mContext, "已经有请求权限", Toast.LENGTH_SHORT).show();
        // -----------location config ------------

        ; // 获取当前SDK版本
       // Log.e("getSDKVersion",locationService.getSDKVersion());
       // locationService.start();
//        LocationClient   mLocationClient = new LocationClient(this); //声明LocationClient类
...
//        mLocationClient.requestLocation();
    ...
    private BDAbstractLocationListener mListener = new BDAbstractLocationListener() {
        ...
        public void onLocDiagnosticMessage(int locType, int diagnosticType, String diagnosticMessage) {
            ...
            Log.e("locationshibai", sb.toString());
        }
    };
}
