 ...
 * 描述:
 */
public abstract class LauncherImageLoader {
    ...
    public abstract void display(ImageView imageView, Uri path, @DrawableRes int loadingResId, @DrawableRes int failResId, int width, int height, DisplayDelegate delegate);
    ...
    public interface DisplayDelegate {
        void onSuccess(View view, Uri path);
    }
