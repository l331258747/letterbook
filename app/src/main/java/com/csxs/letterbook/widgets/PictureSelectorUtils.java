...
public class PictureSelectorUtils {
    ...
    public PictureSelectorUtils(Activity activity, int requestCode, int maxSize, int defaultSize) {

        this.activity = activity;

        this.requestCode = requestCode;

        this.maxSelectImage = maxSize;
...
//            mReferenceView = new WeakReference<PictureSelectorUtils>(new PictureSelectorUtils(activity));
//        }
//        return mReferenceView.get();
//    }

    public void laucherSelector() {
        PictureSelector.create(activity)
                ...
                .maxSelectNum(maxSelectImage)// 最大图片选择数量
...
//        mPictureParameterStyle.pictureWeChatPreviewSelectedTextSize = 9;
    ...
    public int getMaxSelectImage() {
        return maxSelectImage;
    }

    public void setMaxSelectImage(int maxSelectImage) {
        this.maxSelectImage = maxSelectImage;
    }
