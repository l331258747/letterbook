...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.black_cccccc;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = LetterApp.appConext.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = LetterApp.appConext.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
