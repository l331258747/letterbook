package com.csxs.letterbook.widgets.sectionadapter;
...
public abstract class Section {
    ...
    @LayoutRes
    private final Integer topHeaderResourceId;
    @LayoutRes
    ...
    private final boolean topHeaderViewWillBeProvided;
    ...
    public Section(@NonNull final SectionParameters sectionParameters) {
        ...
        this.topHeaderResourceId = sectionParameters.topHeaderResourceId;
        ...
        this.topHeaderViewWillBeProvided=sectionParameters.topHeaderViewWillBeProvided;
    ...
    public final boolean isTopHeaderViewWillBeProvided() {
        return topHeaderViewWillBeProvided;
    }
    ...
    public final Integer getTopHeaderResourceId() {
        return topHeaderResourceId;
    }
    /**
    ...
    public View getTopHeaderView(@SuppressWarnings("unused") final ViewGroup parent) {
        throw new UnsupportedOperationException(
                "You need to implement getTopHeaderView() if you set topHeaderViewWillBeProvided");
    }


    public RecyclerView.ViewHolder getTopHeaderViewHolder(final View view) {
        throw new UnsupportedOperationException(
