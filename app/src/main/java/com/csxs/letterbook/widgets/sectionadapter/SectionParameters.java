...
public final class SectionParameters {
    @LayoutRes
    public final transient Integer topHeaderResourceId;
    @LayoutRes
    ...
    public final transient boolean topHeaderViewWillBeProvided;
    ...
    private SectionParameters(final Builder builder) {
        ...
        topHeaderResourceId = builder.topHeaderResourceId;
        ...
        this.topHeaderViewWillBeProvided = builder.topHeaderViewWillBeProvided;
    ...
    public static class Builder {
        @LayoutRes
        private transient Integer topHeaderResourceId;
        @LayoutRes
        ...
        private transient boolean topHeaderViewWillBeProvided;
        ...
        public Builder topHeaderViewWillBeProvided() {
            topHeaderViewWillBeProvided = true;
            return this;
        }

        public Builder topHeaderResourceId(@LayoutRes final int topHeaderResourceId) {
            this.topHeaderResourceId = topHeaderResourceId;
