...
import com.csxs.letterbook.seller.listener.CheckListener;
...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<SellerGoodsCategoryDetailsE> mDatas;
    ...
    public ItemHeaderDecoration(Context context, List<SellerGoodsCategoryDetailsE> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(List<SellerGoodsCategoryDetailsE> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    private void drawHeader(RecyclerView parent, int pos, Canvas canvas) {
        View topTitleView = mInflater.inflate(R.layout.item_category_title, parent, false);
