...
public class SellerStoreInfoAdapter extends BaseMultiItemQuickAdapter<SellerInfoE, BaseViewHolder> {
    ...
    public SellerStoreInfoAdapter(Context context, List<SellerInfoE> data) {
        super(data);
        this.mContext=context;
        addItemType(SellerInfoE.STORE_TEXT_DESC, R.layout.item_store_desc_text);
