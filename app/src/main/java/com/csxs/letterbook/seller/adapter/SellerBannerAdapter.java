 ...
 * 自定义布局，图片
 */
public class SellerBannerAdapter extends BannerAdapter<MapSellerPictureE, ImageHolder> {

    private Activity context;

    public SellerBannerAdapter(Activity context, List<MapSellerPictureE> mDatas) {
    ...
    //更新数据
    public void updateData(List<MapSellerPictureE> data) {
        //这里的代码自己发挥，比如如下的写法等等
        mDatas.clear();
        mDatas.addAll(data);
    ...
    @Override
    public void onBindView(ImageHolder holder, MapSellerPictureE data, int position, int size) {
